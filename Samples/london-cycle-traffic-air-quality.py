'''
  ...
  By using LatestValueField it performs an operations
...
# inorder to dowload datasets required to run the recipe for more info please refer to documentation
...
# Below are creating 3 Fields two LatestValueFields and 1 ArithmeticField
...
# Then they both are passed to ArithmeticField which takes the fraction of BicycleCount
# by dividing first field from second field
...
# by passing them the location of DigitalConnector, recipe output location, model output location 
